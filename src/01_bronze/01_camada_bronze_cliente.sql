...
CREATE TABLE IF NOT EXISTS seguros_auto.`01_bronze`.bronze_clientes (
    id_cliente INT,
    nome_cliente STRING,
    idade_cliente INT,
    genero STRING,
...
INSERT INTO seguros_auto.`01_bronze`.bronze_clientes
SELECT 
    id_cliente,
    nome_cliente,
    idade_cliente,
...
FROM seguros_auto.`00_landing`.landing_clientes;
